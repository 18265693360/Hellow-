// pages/custom/myWallet/myWallet.js
...
Page({
  ...
  onLoad: function (options) {
    ...
    var that = this
    that.setData({
        'options.agencyId': global.custom.agencyCode,
      })
    if (global.custom.tips.length > 0){
      that.setData({
        tips: global.custom.tips,
        isTips: true
      })
    }
